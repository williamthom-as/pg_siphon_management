defmodule PgSiphonManagement.MixProject do
  use Mix.Project

  def project do
    [
      app: :pg_siphon_management,
      version: "0.1.0",
      elixir: "~> 1.14",
  ...
  def application do
    [
      mod: {PgSiphonManagement.Application, []},
  ...
  defp deps do
    [
      ...
      {:pg_siphon, github: "williamthom-as/pg_siphon", branch: "main"},
      {:csv, "~> 3.2"},
      {:timex, "~> 3.7"},
      {:pg_query_ex, "~> 0.5.4"},
      {:sql_fmt, "~> 0.3.0"}
