...
config :pg_siphon_management, PgSiphonManagement.Repo,
  database: Path.expand("../pg_siphon_management_dev.db", __DIR__),
  pool_size: 5,
  stacktrace: true,
...
config :pg_siphon_management, PgSiphonManagementWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/pg_siphon_management_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :pg_siphon_management, dev_routes: true
